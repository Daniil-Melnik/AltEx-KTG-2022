...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.menuImageERG = customtkinter.CTkImage(Image.open(os.path.join(pathIcons, "leti.png")), size=(24, 24))
        self.menuImageBAG = customtkinter.CTkImage(Image.open(os.path.join(pathIcons, "leti.png")), size=(24, 24))
        self.menuImageBRG = customtkinter.CTkImage(Image.open(os.path.join(pathIcons, "leti.png")), size=(24, 24))
        ...
        self.MenuButtonERG = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="Home", fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"), image=self.menuImageERG, anchor="w", command=self.MenuButtonERG_event)
        self.MenuButtonERG.grid(row=1, column=0, sticky="ew")
        self.MenuButtonBAG = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="Frame 2", fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"), image=self.menuImageBAG, anchor="w", command=self.MenuButtonBAG_event)
        self.MenuButtonBAG.grid(row=2, column=0, sticky="ew")
        self.MenuButtonBRG = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="Frame 3", fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"), image=self.menuImageBRG, anchor="w", command=self.MenuButtonBRG_event)
