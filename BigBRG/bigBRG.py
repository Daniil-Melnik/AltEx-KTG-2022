...
class GraphBarabasiAlbert:
    ...
    def add_v(self):
        ...
        nx.draw(self.G, node_color=colorMapNode ,edge_color = colorMapEdge,with_labels = False)
        plt.axis('on')
...
img = ImageTk.PhotoImage(Image.open("start3big.png"))
...
btn1.place(x=1095, y=200)

btn2 = Button(root, text="добавить", command=g.add_v, width=10, height=1, font='Arial 20 bold', background='#228B22', foreground='#FFFFFF')
btn2.place(x=1095, y=300)
